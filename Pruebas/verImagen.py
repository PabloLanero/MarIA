...
response = chat(
  model='erwan2/DeepSeek-Janus-Pro-7B:latest',
...
print(f"Scenario: {image_analysis.scene}")
for objecto in image_analysis.objects:
    print(f"Persona {objecto.name}\nAtributos: {objecto.attributes}")
    
    
print(f"Resumen: {image_analysis.summary}")
